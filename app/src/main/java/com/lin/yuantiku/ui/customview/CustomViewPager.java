 ...
 * book_detail. You supply an implementation of a
...
public class CustomViewPager extends ViewGroup {
    ...
    /**
     * Indicates that the bookViewPager is in an idle, settled state. The current page
     * is fully in view and no animation is in progress.
     */
    public static final int SCROLL_STATE_IDLE = 0;

    /**
     * Indicates that the bookViewPager is currently being dragged by the user.
     */
    public static final int SCROLL_STATE_DRAGGING = 1;

    /**
     * Indicates that the bookViewPager is in the process of settling to a final
     * position.
     */
    ...
    public interface OnPageChangeListener {
         ...
         * user begins dragging, when the bookViewPager is automatically settling to the
     ...
     * through its first item_task_unfinish there will be a smooth animated transition
     ...
     * will be spent in item_task_unfinish for newly created view subtrees as the user pages
     * back and forth.
     * </p>
     * <p>
     * <p>
        ...
        switch (action) {
			 ...
			 */
                ...
                if (mScrollState == SCROLL_STATE_SETTLING) {
                    // Let the user 'catch' the bookViewPager as it animates.
                    mIsBeingDragged = true;
                    mIsUnableToDrag = false;
                    setScrollState(SCROLL_STATE_DRAGGING);
                } else {
    ...
    /**
     * Start a fake drag of the bookViewPager.
     * <p>
     * <p>
    ...
    /**
     * End a fake drag of the bookViewPager.
     *
     * @see #beginFakeDrag()
     * @see #fakeDragBy(float)
     */
     ...
     *
     * @param v      View to clickFromNotification for horizontal scrollability
